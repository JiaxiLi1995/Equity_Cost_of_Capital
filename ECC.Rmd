...
From both regression results, we can see that the seasonality would encourage the filtering method, and idiosyncratic error would discourage the filtering method.

...
Port_FF5_STL_s7_norobust %>%
  ...
  ggplot() +
  geom_density(aes(Value, linetype = component), adjust=1.5) +
  scale_linetype_manual(values=c("dotdash", "solid")) +
  facet_wrap(~ Moment,
             ncol = 2,
             scales = "free") +
...
Port_FF5_STL_s7_norobust %>%
  ...
  ggplot() +
  geom_density(aes(StdDev, linetype = component), adjust=1.5) +
  scale_linetype_manual(values=c("solid", "dotdash", "1F")) +

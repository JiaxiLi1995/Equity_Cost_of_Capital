...
![](ECC_files/figure-gfm/Aux_reg_Trend-1.png)<!-- -->![](ECC_files/figure-gfm/Aux_reg_Trend-2.png)<!-- -->
    ...
    ##    Mkt-RF       SMB       HML       RMW       CMA 
    ## 0.3157639 0.2384162 0.1911467 0.3030013 0.1635150

We obtain similar results for trend component although slightly more
significant.
...
It seems that 30% of the time, the result from long regression would be
different from the ACL regression. This result is consistent with
